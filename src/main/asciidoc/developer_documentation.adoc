...
|Spring.WebMvcConfigurer |org.springframework.web.servlet.config.annotation.WebMvcConfigurer  a| *gym.WebSecurityConfiguration
...
|Spring.AbstractView|org.springframework.web.servlet.view.AbstractView|*pdf.PdfView
|===
...
image::models/design/staffManagemenetSequenz.jpg[]
