...
Wartbarkeit::
Beschreibt, wie einfach es ist, das System zu warten. 

Benutzbarkeit::
Qualität der Bedienung des Programms durch einen Nutzer.

Effizienz::
Beschreibt, wie effizient das Programm funktioniert.
...
Zuverlässigkeit::
Wahrscheinlichkeit der fehlerfreien Funktion des Programms.
...
Erreichbarkeit::
Beschreibt wie durchgehend das System 
