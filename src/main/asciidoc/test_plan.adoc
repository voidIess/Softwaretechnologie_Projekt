...
|U-3-09
|Slot.delete
|Wenn Eintrag aus Slot gelöscht wird soll er auch verschwinden.
|true

|U-3-10
|Slot.delete
|Wenn Eintrag im Slot nicht exisitiert, dann muss ein Fehler auftreten.
|true

|U-3-11
|Slot.isTaken
|Wenn ein Mitarbeiter bereits arbeitet soll true zurück gegeben werden.
|true

|U-3-12
|Slot.sortList
|Einträge mit Rolle COUNTER sollen vor Einträgen mit Rolle TRAINER kommen.
|true
