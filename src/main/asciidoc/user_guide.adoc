...
Um nun einen neuen Dienstplaneintrag zu erstellen, drückt man auf den "Eintrag erstellen"-Button am Ende der Übersichtsseits. Dort gelangt man zu einem Formular.
