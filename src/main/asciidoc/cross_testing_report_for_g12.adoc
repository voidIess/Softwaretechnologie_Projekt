...
.Theken
* Artikel können nicht neu hinzugefügt, bearbeitet und gelöscht werden
* Rabatt hat keinen bestimmten Zeitraum
...
| registrieren |Kundennummer = 12|Anwerbungsprämie wird in das Kundenkonto nicht gutgeschrieben, wenn man mit Kundennummer vom Anwerber erfolgreich registriert hat|-
