...
schedule|Datum = 24.12.2019| Man muss nur immer Datum als Input mit Format yyyy-MM-dddd eingeben. D.h wenn man in Chrome(oder andere Browser mit Date-Integration-Format in Inputfeld), bekommt man White label error page.|white label error 500 page oder Text '' could not be parsed at index 0|
