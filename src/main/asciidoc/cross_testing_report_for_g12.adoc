...
| registrieren |Kundennummer = 12|Anwerbungsprämie wird in das Guthaben nicht hinzugefügt, wenn man mit Kundennummer vom Anwerber erfolgreich registriert hat|-
