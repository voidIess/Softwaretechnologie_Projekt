...
|Auslöser                    |
Mitglied kauft etwas an der Theke.
|Vorbedingungen a|
Der Mitarbeiter muss als Staff im System angemeldet sein. Es muss ein Inventar geben. 
|Wichtige Schritte           a|
...
|Akteur                     |Staff 
|Auslöser                    |
Mitarbeiter möchte Inventar ansehen.
|Vorbedingungen a|
...
|Auslöser                    |
Neues Kundenkonto soll erstellt werden.
|Vorbedingungen a|
...
|Akteur                     |Unregistered User
|Auslöse                    |_CheckIn_: Nutzer betritt das Fitnessstudio.
...
|Akteur                     |Staff
|Auslöser               | Ein neues Nutzerkonto wurde erstellt und muss jetzt noch freigegeben werden.
