...
|===
|Name |Beschreibung
|_User_ | Repräsentiert jede Person, welche einen Nutzeraccount besitzt, eingeloggt ist und mit dem System interagiert. Dabei ist die Rolle des Accounts egal.
|_Unregistered User_ | Repräsentiert jede Person, welche mit dem System interagiert, aber sich noch nicht eingeloggt hat. Darunter zählen auch alle Nutzer der Anwendung, welche noch keinen Nutzeraccount haben.
